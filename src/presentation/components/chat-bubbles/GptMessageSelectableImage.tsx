...
export const GptMessageSelectableImage = ({imagenUrl, onImageSelected}: Props) => {
    ...
    const resetCanva = () => {
        ...
        onImageSelected && onImageSelected(imagenUrl);
    };
    return (
        <div className="col-start-1 col-end-9 p-3 rounded-lg">
            <div className="flex flex-row items-start">
                ...
                <div className="relative ml-3 text-sm bg-black bg-opacity-25 pt-3 pb-2 px-4 shadow rounded-xl">
                    ...
                    />
                    <button className="btn-primary mt-2" onClick={resetCanva}>Borrar Seleccion</button>
                </div>
            </div>
        </div>
    );
